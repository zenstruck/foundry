            ...
            ->children()
                ...
                ->arrayNode('instantiator')
                    ...
                    ->children()
                        ...
                        ->end()
                        ->booleanNode('allow_extra_attributes') // todo deprecate
                            ->defaultFalse()
                            ->info('Whether or not to allow extra attributes.')
                        ->end()
                        ->booleanNode('always_force_properties') // todo deprecate
                            ->defaultFalse()
                ...
                ->arrayNode('hydrator')
                    ->addDefaultsIfNotSet()
                    ->info('Configure the default hydrator used by your factories.')
                    ->validate()
                        ->ifTrue(static fn(array $v) => $v['service'] && $v['allow_extra_attributes'])
                        ->thenInvalid('Cannot set "allow_extra_attributes" when using custom service.')
                    ->end()
                    ...
                    ->children()
                        ...
                        ->scalarNode('service')
                            ->defaultNull()
                            ->info('Customize the hydrator service.')
                            ->example('my_hydrator')
                        ->end()
                    ->end()
                ->end()
