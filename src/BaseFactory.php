...
abstract class BaseFactory
{
    ...
    final public static function new(array|callable|string $attributes = [], string ...$states): static
    {
        if (\is_string($attributes) || $states) {
            trigger_deprecation('zenstruck/foundry', '1.32', 'Passing states as strings is deprecated and this behavior will be removed in 2.0.', self::class, BaseFactory::class);
        }
    ...
    {
        if (!self::isBooted()) {
            throw new FoundryNotBootedException(self::class);
        }
