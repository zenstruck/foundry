...
final class TestState
{
    ...
    {
        trigger_deprecation('zenstruck/foundry', '1.38.0', 'Method "%s()" is deprecated and will be removed in Foundry 2.0. Use "%s::configure()" instead.', __METHOD__, UnitTestConfig::class);
    ...
    {
        trigger_deprecation('zenstruck/foundry', '1.38.0', 'Method "%s()" is deprecated and will be removed in Foundry 2.0 without replacement.', __METHOD__);
