 ...
 * @phpstan-method static StandardCategory&Proxy<StandardCategory> first(string $sortedField = 'id')
 * @phpstan-method static StandardCategory&Proxy<StandardCategory> last(string $sortedField = 'id')
